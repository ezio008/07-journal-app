<template>
    <div class="entry-container mb-3 pointer p-2" @click="$router.push({ name: 'entry', params: { id: 10 } })">
        ...
        <div class="entry-description">
            Adipisicing ad sit et consectetur irure duis fugiat tempor incididunt enim id. Duis duis eu exercitation et
            nulla sit laboris aute sint ullamco. Nisi Lorem sit ipsum anim sit duis commodo.
        </div>
    </div>
</template>
